...
const Modal = () => {
    ...
    const addFriend = async () => {
        try {
            ...
            await setDoc(friendRef, {
                ...
                startDate: null, // 친구 등록일은 친구가 수락하면 생성
            });
    ...
    return (
        <div>   
            ...
            {isOpen && (
                <div className={tgl["add-f-modal-m"]}>

                    <div className={tgl["add-f-modal-background"]}>

                        <div className={tgl["add-f-modal-content"]}>

                            <div onClick={closeModal} className={tgl["add-f-modal-close"]}><GrClose /></div>

                            <div className={tgl["add-f-modal-container"]}>

                                <div className={tgl["add-f-content"]}>

                                    <div className={tgl['add-f-modal-title']}>친구 추가</div>
                                    <div className={tgl['add-f-modal-form']}>
                                        ...
                                        <div className={`${tgl['add-f-cal-btns']}`}>
                                            <button className={`${tgl['add-f-calender-btn']} ${mainStyle['button']}
                                                ${selectA ? tgl['add-f-c-select'] : tgl['add-f-no-c-select']}
                                            `}
                                                onClick={() => { setSelectA(true); }}
                                            >A 캘린더</button>
                                            <button className={`${tgl['add-f-calender-btn']} ${mainStyle['button']}
                                                ${selectA ? tgl['add-f-no-c-select'] : tgl['add-f-c-select']}
                                            `}
                                    ...
                                    <div className={tgl['add-f-make-friend']}>
                                        {
                                            selectF ?
